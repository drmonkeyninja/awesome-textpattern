...
* "upm_pending_notify":https://github.com/wcz-txp/upm_pending_notify - Pending article notification.
...
* "Textpattern Default Theme":https://github.com/textpattern/textpattern-default-theme
