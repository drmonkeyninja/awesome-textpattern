...
*This list is for the latest version of Textpattern (v4.6.x).*
...
* "oui_video":https://github.com/NicolasGraph/oui_video - Easily embed Vimeo, Youtube or Dailymotion videos.
