...
* "oui_embed":https://github.com/NicolasGraph/oui_embed - Embed any information, from any web page using oembed, opengraph, twitter-cards, scrapping the html, etc. Requires "Embed":https://github.com/oscarotero/Embed
* "oui_instagram":https://github.com/NicolasGraph/oui_instagram - Easily embed Instagram recent images galleries.
* "oui_player":https://github.com/NicolasGraph/oui_player - Easily embed configurable video/music players from a growing providers list.
...
* "Official website":http://textpattern.com/ - Download link, features description and links to start enjoying Txp.
* "Official online documentation":http://docs.textpattern.io/ - The user Bible.
